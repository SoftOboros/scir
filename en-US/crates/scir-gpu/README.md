...
Features
- cuda: enables CUDA Driver API usage with embedded PTX kernels for f32 element-wise add/mul and batched FIR.
...
- Element-wise: `add_scalar_auto`, `mul_scalar_auto`, `add_auto` (f32) dispatch to CUDA when available.
