...
Overview
- Use an ECR image based on an NVIDIA CUDA devel image with the Rust toolchain pre-installed. This repo provides `ci/docker/Dockerfile.cuda` as a starting point.
